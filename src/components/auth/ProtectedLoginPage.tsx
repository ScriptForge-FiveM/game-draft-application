      ...
      <div className="fixed top-6 left-6 z-50">
        {user ? (
          <button
            ...
            disabled={signingOut}
            className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-3 group disabled:opacity-50"
          >
            {signingOut ? (
              <>
                <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
                <span>Disconnettendo...</span>
              </>
            ) : (
              <>
                <LogOut className="w-6 h-6" />
                <span className="group-hover:scale-105 transition-transform">Disconnetti</span>
              </>
            )}
          </button>
        ) : (
          <button
            ...
            disabled={signingIn}
            className="bg-gradient-to-r from-blue-800 to-blue-600 hover:from-blue-700 hover:to-blue-1000 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-3 group disabled:opacity-50"
          >
            {signingIn ? (
              <>
                <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
              ...
              <>
                ...
                <span className="group-hover:scale-105 transition-transform">Accedi con Discord</span>
              </>
            )}
          </button>
        )}
              ...
              {eventsToShow.length === 0 ? (
                <div className="text-center py-16">
                  <div className="card p-12 max-w-2xl mx-auto">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800 mb-4">Nessun Evento Disponibile</h3>
                ...
                <div className={`grid gap-6 ${
                  ...
                  {eventsToShow.map((event, index) => (
                    <div 
                      key={event.id} 
                      className="card p-6 hover-lift fade-in"
                        ...
                        <div className="flex flex-col items-end space-y-2">
                          ...
                          {event.twitch_channel && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white text-xs font-medium rounded-full transition-all duration-200 hover:scale-105 hover:shadow-lg"
                            >
                              <svg className="h-3 w-3 mr-1" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z"/>
                              </svg>
                              <span>Guarda su Twitch</span>
                      ...
                      <div className="space-y-3 mb-6">
                        ...
                        {event.organizer_name && (
                          <div className="flex items-center text-gray-700">
                            ...
                            <span className="font-medium">Organizzatore: {event.organizer_name}</span>
                          </div>
                        )}
                        {event.scheduled_at && (
                          <div className="flex items-center text-gray-700">
          ...
          <div className="card p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-bold text-gray-800 mb-2">Registrati</h4>
                <p className="text-gray-600 text-sm">Accedi con Discord e scegli il tuo evento</p>
              </div>
              <div className="text-center">
                <div className="bg-green-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                  <Trophy className="h-8 w-8 text-green-600" />
                </div>
                <h4 className="font-bold text-gray-800 mb-2">Partecipa</h4>
                <p className="text-gray-600 text-sm">Entra nel draft e forma la tua squadra</p>
              </div>
              <div className="text-center">
                <div className="bg-purple-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                  <Play className="h-8 w-8 text-purple-600" />
                </div>
                <h4 className="font-bold text-gray-800 mb-2">Competi</h4>
                <p className="text-gray-600 text-sm">Gioca nel torneo e vinci premi</p>
              </div>
            </div>
          </div>
        </div>
